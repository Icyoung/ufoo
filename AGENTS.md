...
> **Record decisions before acting.** Only for important, plan-level knowledge: architectural choices, trade-off analysis, cross-agent coordination. NOT for routine findings or simple fixes. → `ufoo ctx decisions new "Title"` BEFORE you act on it.
